...
| <a name="input_use_storage_account_network_rule_action"></a> [use\_storage\_account\_network\_rule\_action](#input\_use\_storage\_account\_network\_rule\_action) | Configure azurerm\_storage\_account\_network\_rules resource | `string` | `false` | no |
| <a name="input_use_storage_account_network_rules"></a> [use\_storage\_account\_network\_rules](#input\_use\_storage\_account\_network\_rules) | Configure azurerm\_storage\_account\_network\_rules resource | `bool` | `"DENY"` | no |
